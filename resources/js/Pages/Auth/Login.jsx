    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-brand-600 via-brand-700 to-brand-900 items-center justify-center p-12 overflow-hidden">
                ...
                <div className="absolute top-0 left-0 w-96 h-96 bg-brand-400 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-blob"></div>
                ...
                <div className="relative z-10 text-white max-w-md">
                    <div className="mb-8">
                        ...
                        <p className="text-brand-100 text-lg leading-relaxed">
                            Sign in to continue connecting donors with recipients and saving lives in your community.
                        </p>
                    </div>
                    ...
                    <div className="space-y-4 bg-white/10 backdrop-blur-sm rounded-2xl p-6 border border-white/20">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-brand-100 text-sm">Get alerted when someone needs your blood type</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-3">
                            <div className="bg-white/20 p-2 rounded-lg mt-1">
                            ...
                            <div>
                                ...
                                <p className="text-brand-100 text-sm">Connect with trusted donors and recipients</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="block w-full pl-12 pr-4 py-3.5 bg-gray-50 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
